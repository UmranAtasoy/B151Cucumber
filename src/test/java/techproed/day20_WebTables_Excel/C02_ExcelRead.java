...
public class C02_ExcelRead  {
    ...
    public void excelReadTest1() throws IOException {
        ...
        String dosyaYolu = "src/test/java/resourses/Capitals(2) (2).xlsx";

        // 2- Capitals(2) dosyasını bizim sistemimize getirmeliyiz. Dosyayı okuyabilmek icin akışa almalıyız.
