...
WebDriver driver ;
    ...
    public void test01() {
       ...
       driver.get("https://testcenter.techproeducation.com/index.php?page=dropdown");
        ...
        // Programlama Dili Dropdown'undan "Java" seciniz
WebElement ddmselectLanguange = driver.findElement(By.xpath("//select[@name='Languages']"));
        Select select = new Select(ddmselectLanguange);
        select.selectByVisibleText("Java");

        // Programlama Dili Dropdown'undan son secilen option'un "Java" oldugunu test ediniz
WebElement sonSecilen = select.getFirstSelectedOption();
        String secimStr = sonSecilen.getText();
        Assert.assertEquals("Java", secimStr);
